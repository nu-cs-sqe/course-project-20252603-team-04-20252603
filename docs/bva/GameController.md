...
- **TC3: startGame_WithOnePlayer_ThrowsException** ( :x: )
...
- **TC9: handleRollDice_BeforeGameStart_DoesNotMovePlayer** ( :x: )
...
- **TC10: handleRollDice_WithMinimumRoll_MovesTwoSpaces** ( :x: )
...
- **TC11: handleRollDice_WithMaximumRoll_MovesTwelveSpaces** ( :x: )
...
- **TC12: handleRollDice_WhenMinimumRollWrapsToGo_MovesToZero** ( :x: )
...
- **TC13: handleRollDice_WhenMaximumRollWrapsAroundBoard_MovesToExpectedIndex** ( :x: )
...
- **TC14: handleRollDice_WhenCurrentPlayerIsBankrupt_DoesNotMovePlayer** ( :x: )
...
- **TC15: handleRollDice_WhenTileEffectCausesBankruptcy_HandlesBankruptcy** ( :x: )
...
- **TC16: handleTileAction_WithNullAction_ThrowsException** ( :x: )
  - **State of the system**: game is in progress, `action = null`
  - **Expected output**: throws `NullPointerException`; no game state changes

- **TC17: handleTileAction_WithValidNoOpAction_RefreshesViewsOnly** ( :x: )
...
- **TC18: handleTileAction_WithPurchaseAtExactBalance_AllowsPurchase** ( :x: )
...
- **TC19: handleTileAction_WithOptionalPurchaseAboveBalance_DoesNotPurchase** ( :x: )
...
- **TC20: handleTileAction_WithMandatoryPaymentAtExactBalance_PaysSuccessfully** ( :x: )
...
- **TC21: handleTileAction_WithMandatoryPaymentAboveBalance_TriggersBankruptcy** ( :x: )
...
- **TC22: handleTileAction_WithActionForWrongTile_RejectsAction** ( :x: )
...
- **TC23: handleEndTurn_BeforeGameStart_DoesNotAdvanceTurn** ( :x: )
  - **State of the system**: `game = null` or game status is not started
  - **Expected output**: operation is rejected or ignored; no current player is selected

- **TC24: handleEndTurn_WithTwoPlayers_AdvancesToSecondPlayer** ( :x: )
...
- **TC25: handleEndTurn_WithMaximumPlayersMiddleTurn_AdvancesToNextPlayer** ( :x: )
...
- **TC26: handleEndTurn_WithMaximumPlayersAtLastTurn_WrapsToFirstPlayer** ( :x: )
...
- **TC27: handleEndTurn_WithOneActivePlayer_EndsGame** ( :x: )
...
- **TC28: handleEndTurn_WhenNextPlayerIsBankrupt_SkipsRemovedPlayer** ( :x: )
...
- **TC29: handleBankruptcy_WithNullPlayer_ThrowsException** ( :x: )
...
- **TC30: handleBankruptcy_WithPlayerNotInGame_DoesNotChangeGame** ( :x: )
...
- **TC31: handleBankruptcy_WithThreePlayers_RemovesPlayerAndContinuesGame** ( :x: )
...
- **TC32: handleBankruptcy_WithTwoPlayers_RemovesPlayerAndEndsGame** ( :x: )
...
- **TC33: handleBankruptcy_WhenCurrentPlayerIsRemoved_AdvancesToNextActivePlayer** ( :x: )
...
- **TC34: handleBankruptcy_WhenLastPlayerInTurnOrderIsRemoved_WrapsCurrentPlayer** ( :x: )
...
- **TC35: refreshViews_BeforeGameStart_ShowsEmptyOrInitialState** ( :x: )
...
- **TC36: refreshViews_WithAllViewsPresent_UpdatesEveryView** ( :x: )
...
- **TC37: refreshViews_WithNullBoardView_ThrowsExceptionBeforePartialUpdate** ( :x: )
...
- **TC38: refreshViews_WhenPlayerAtFirstBoardIndex_RendersPositionZero** ( :x: )
...
- **TC39: refreshViews_WhenPlayerAtLastBoardIndex_RendersPositionThirtyOne** ( :x: )
...
- **TC40: refreshViews_WhenNoCardIsActive_ClearsCardView** ( :x: )
...
- **TC41: refreshViews_WhenCardIsActive_DisplaysCurrentCard** ( :x: )
...
- **TC42: refreshViews_AfterBankruptcy_RemovesPlayerFromVisibleTurnOrder** ( :x: )
