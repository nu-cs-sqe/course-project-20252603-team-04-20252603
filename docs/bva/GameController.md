...
2. Input type: none
3. Output boundary values: first player, middle player, last player

- **TC5: getCurrentPlayer_WhenGameEngineCurrentPlayerIsFirstPlayer_ReturnsFirstPlayer** ( :x: )
  - **State of the system**: mocked or stubbed `GameEngine.getCurrentPlayer()` returns `P1`
  - **Expected output**: controller returns `P1`

- **TC6: getCurrentPlayer_WhenGameEngineCurrentPlayerIsMiddlePlayer_ReturnsMiddlePlayer** ( :x: )
...
- **TC7: getCurrentPlayer_WhenGameEngineCurrentPlayerIsLastPlayer_ReturnsLastPlayer** ( :x: )
...
- **TC8: getActivePlayers_WhenGameEngineActivePlayersIsEmpty_ReturnsEmptyList** ( :x: )
  - **State of the system**: mocked or stubbed `GameEngine.getActivePlayers()` returns `[]`
  - **Expected output**: controller returns `[]`

- **TC9: getActivePlayers_WhenGameEngineHasMinimumPlayers_ReturnsBothPlayers** ( :x: )
...
- **TC10: getActivePlayers_WhenGameEngineHasMaximumPlayers_ReturnsAllPlayers** ( :x: )
...
- **TC11: getActivePlayers_WhenGameEngineHasOneRemainingPlayer_ReturnsWinnerOnly** ( :x: )
  - **State of the system**: mocked or stubbed `GameEngine.getActivePlayers()` returns `[P1]`
  - **Expected output**: controller returns `[P1]`

- **TC12: getActivePlayers_ReturnedListCannotMutateControllerState** ( :x: )
...
- **TC13: startGame_WithNullPlayerList_ThrowsException** ( :white_check_mark: )
...
- **TC14: startGame_WithZeroPlayers_ThrowsException** ( :white_check_mark: )
  - **State of the system**: `players = []`
  - **Expected output**: throws `IllegalArgumentException`; `game` remains not started

- **TC15: startGame_WithOnePlayer_ThrowsException** ( :x: )
  - **State of the system**: `players = [P1]`
  - **Expected output**: throws `IllegalArgumentException`; `game` remains not started

- **TC16: startGame_WithMinimumPlayers_StartsGame** ( :x: )
...
- **TC17: startGame_WithMaximumPlayers_StartsGame** ( :x: )
...
- **TC21: handleRollDice_BeforeGameStart_DoesNotMovePlayer** ( :x: )
...
- **TC22: handleRollDice_WithMinimumRoll_MovesTwoSpaces** ( :x: )
...
- **TC23: handleRollDice_WithMaximumRoll_MovesTwelveSpaces** ( :x: )
...
- **TC24: handleRollDice_WhenMinimumRollWrapsToGo_MovesToZero** ( :x: )
...
- **TC25: handleRollDice_WhenMaximumRollWrapsAroundBoard_MovesToExpectedIndex** ( :x: )
...
- **TC26: handleRollDice_WhenCurrentPlayerIsBankrupt_DoesNotMovePlayer** ( :x: )
...
- **TC27: handleRollDice_WhenTileEffectCausesBankruptcy_HandlesBankruptcy** ( :x: )
...
- **TC28: handleTileAction_WithNullAction_ThrowsException** ( :x: )
  - **State of the system**: game is in progress, `action = null`
  - **Expected output**: throws `NullPointerException`; no game state changes

- **TC29: handleTileAction_WithValidNoOpAction_RefreshesViewsOnly** ( :x: )
...
- **TC30: handleTileAction_WithPurchaseAtExactBalance_AllowsPurchase** ( :x: )
...
- **TC31: handleTileAction_WithOptionalPurchaseAboveBalance_DoesNotPurchase** ( :x: )
...
- **TC32: handleTileAction_WithMandatoryPaymentAtExactBalance_PaysSuccessfully** ( :x: )
...
- **TC33: handleTileAction_WithMandatoryPaymentAboveBalance_TriggersBankruptcy** ( :x: )
...
- **TC34: handleTileAction_WithActionForWrongTile_RejectsAction** ( :x: )
...
- **TC35: handleEndTurn_BeforeGameStart_DoesNotAdvanceTurn** ( :x: )
  - **State of the system**: `game = null` or game status is not started
  - **Expected output**: operation is rejected or ignored; no current player is selected

- **TC36: handleEndTurn_WithTwoPlayers_AdvancesToSecondPlayer** ( :x: )
...
- **TC37: handleEndTurn_WithMaximumPlayersMiddleTurn_AdvancesToNextPlayer** ( :x: )
...
- **TC38: handleEndTurn_WithMaximumPlayersAtLastTurn_WrapsToFirstPlayer** ( :x: )
...
- **TC39: handleEndTurn_WithOneActivePlayer_EndsGame** ( :x: )
...
- **TC40: handleEndTurn_WhenNextPlayerIsBankrupt_SkipsRemovedPlayer** ( :x: )
...
- **TC41: handleBankruptcy_WithNullPlayer_ThrowsException** ( :x: )
...
- **TC42: handleBankruptcy_WithPlayerNotInGame_DoesNotChangeGame** ( :x: )
...
- **TC43: handleBankruptcy_WithThreePlayers_RemovesPlayerAndContinuesGame** ( :x: )
...
- **TC44: handleBankruptcy_WithTwoPlayers_RemovesPlayerAndEndsGame** ( :x: )
...
- **TC45: handleBankruptcy_WhenCurrentPlayerIsRemoved_AdvancesToNextActivePlayer** ( :x: )
...
- **TC46: handleBankruptcy_WhenLastPlayerInTurnOrderIsRemoved_WrapsCurrentPlayer** ( :x: )
...
- **TC47: refreshViews_BeforeGameStart_ShowsEmptyOrInitialState** ( :x: )
...
- **TC48: refreshViews_WithAllViewsPresent_UpdatesEveryView** ( :x: )
...
- **TC49: refreshViews_WithNullBoardView_ThrowsExceptionBeforePartialUpdate** ( :x: )
...
- **TC50: refreshViews_WhenPlayerAtFirstBoardIndex_RendersPositionZero** ( :x: )
...
- **TC51: refreshViews_WhenPlayerAtLastBoardIndex_RendersPositionThirtyOne** ( :x: )
...
- **TC52: refreshViews_WhenNoCardIsActive_ClearsCardView** ( :x: )
...
- **TC53: refreshViews_WhenCardIsActive_DisplaysCurrentCard** ( :x: )
...
- **TC54: refreshViews_AfterBankruptcy_RemovesPlayerFromVisibleTurnOrder** ( :x: )
