...
- **TC1: getStatus_WhenGameEngineIsNull_ThrowsNullPointerException** ( :white_check_mark: )
...
- **TC5: getCurrentPlayer_WhenGameEngineIsNull_ReturnsNullOrThrowsException** ( :x: )
  - **State of the system**: controller has no `GameEngine`
  - **Expected output**: returns `null` or throws `IllegalStateException` consistently

- **TC6: getCurrentPlayer_WhenGameEngineCurrentPlayerIsFirstPlayer_ReturnsFirstPlayer** ( :x: )
  - **State of the system**: mocked or stubbed `GameEngine.getCurrentPlayer()` returns `P1`
  - **Expected output**: controller returns `P1`

- **TC7: getCurrentPlayer_WhenGameEngineCurrentPlayerIsMiddlePlayer_ReturnsMiddlePlayer** ( :x: )
...
- **TC8: getCurrentPlayer_WhenGameEngineCurrentPlayerIsLastPlayer_ReturnsLastPlayer** ( :x: )
...
- **TC9: getActivePlayers_WhenGameEngineIsNull_ReturnsEmptyListOrThrowsException** ( :x: )
  - **State of the system**: controller has no `GameEngine`
  - **Expected output**: returns an empty list or throws `IllegalStateException` consistently

- **TC10: getActivePlayers_WhenGameEngineActivePlayersIsEmpty_ReturnsEmptyList** ( :x: )
  - **State of the system**: mocked or stubbed `GameEngine.getActivePlayers()` returns `[]`
  - **Expected output**: controller returns `[]`

- **TC11: getActivePlayers_WhenGameEngineHasMinimumPlayers_ReturnsBothPlayers** ( :x: )
...
- **TC12: getActivePlayers_WhenGameEngineHasMaximumPlayers_ReturnsAllPlayers** ( :x: )
...
- **TC13: getActivePlayers_WhenGameEngineHasOneRemainingPlayer_ReturnsWinnerOnly** ( :x: )
  - **State of the system**: mocked or stubbed `GameEngine.getActivePlayers()` returns `[P1]`
  - **Expected output**: controller returns `[P1]`

- **TC14: getActivePlayers_ReturnedListCannotMutateControllerState** ( :x: )
...
- **TC15: startGame_WithNullPlayerList_ThrowsException** ( :white_check_mark: )
...
- **TC16: startGame_WithZeroPlayers_ThrowsException** ( :white_check_mark: )
  - **State of the system**: `players = []`
  - **Expected output**: throws `IllegalArgumentException`; `game` remains not started

- **TC17: startGame_WithOnePlayer_ThrowsException** ( :x: )
  - **State of the system**: `players = [P1]`
  - **Expected output**: throws `IllegalArgumentException`; `game` remains not started

- **TC18: startGame_WithMinimumPlayers_StartsGame** ( :x: )
...
- **TC19: startGame_WithMaximumPlayers_StartsGame** ( :x: )
...
- **TC23: handleRollDice_BeforeGameStart_DoesNotMovePlayer** ( :x: )
...
- **TC24: handleRollDice_WithMinimumRoll_MovesTwoSpaces** ( :x: )
...
- **TC25: handleRollDice_WithMaximumRoll_MovesTwelveSpaces** ( :x: )
...
- **TC26: handleRollDice_WhenMinimumRollWrapsToGo_MovesToZero** ( :x: )
...
- **TC27: handleRollDice_WhenMaximumRollWrapsAroundBoard_MovesToExpectedIndex** ( :x: )
...
- **TC28: handleRollDice_WhenCurrentPlayerIsBankrupt_DoesNotMovePlayer** ( :x: )
...
- **TC29: handleRollDice_WhenTileEffectCausesBankruptcy_HandlesBankruptcy** ( :x: )
...
- **TC30: handleTileAction_WithNullAction_ThrowsException** ( :x: )
  - **State of the system**: game is in progress, `action = null`
  - **Expected output**: throws `NullPointerException`; no game state changes

- **TC31: handleTileAction_WithValidNoOpAction_RefreshesViewsOnly** ( :x: )
...
- **TC32: handleTileAction_WithPurchaseAtExactBalance_AllowsPurchase** ( :x: )
...
- **TC33: handleTileAction_WithOptionalPurchaseAboveBalance_DoesNotPurchase** ( :x: )
...
- **TC34: handleTileAction_WithMandatoryPaymentAtExactBalance_PaysSuccessfully** ( :x: )
...
- **TC35: handleTileAction_WithMandatoryPaymentAboveBalance_TriggersBankruptcy** ( :x: )
...
- **TC36: handleTileAction_WithActionForWrongTile_RejectsAction** ( :x: )
...
- **TC37: handleEndTurn_BeforeGameStart_DoesNotAdvanceTurn** ( :x: )
  - **State of the system**: `game = null` or game status is not started
  - **Expected output**: operation is rejected or ignored; no current player is selected

- **TC38: handleEndTurn_WithTwoPlayers_AdvancesToSecondPlayer** ( :x: )
...
- **TC39: handleEndTurn_WithMaximumPlayersMiddleTurn_AdvancesToNextPlayer** ( :x: )
...
- **TC40: handleEndTurn_WithMaximumPlayersAtLastTurn_WrapsToFirstPlayer** ( :x: )
...
- **TC41: handleEndTurn_WithOneActivePlayer_EndsGame** ( :x: )
...
- **TC42: handleEndTurn_WhenNextPlayerIsBankrupt_SkipsRemovedPlayer** ( :x: )
...
- **TC43: handleBankruptcy_WithNullPlayer_ThrowsException** ( :x: )
...
- **TC44: handleBankruptcy_WithPlayerNotInGame_DoesNotChangeGame** ( :x: )
...
- **TC45: handleBankruptcy_WithThreePlayers_RemovesPlayerAndContinuesGame** ( :x: )
...
- **TC46: handleBankruptcy_WithTwoPlayers_RemovesPlayerAndEndsGame** ( :x: )
...
- **TC47: handleBankruptcy_WhenCurrentPlayerIsRemoved_AdvancesToNextActivePlayer** ( :x: )
...
- **TC48: handleBankruptcy_WhenLastPlayerInTurnOrderIsRemoved_WrapsCurrentPlayer** ( :x: )
...
- **TC49: refreshViews_BeforeGameStart_ShowsEmptyOrInitialState** ( :x: )
...
- **TC50: refreshViews_WithAllViewsPresent_UpdatesEveryView** ( :x: )
...
- **TC51: refreshViews_WithNullBoardView_ThrowsExceptionBeforePartialUpdate** ( :x: )
...
- **TC52: refreshViews_WhenPlayerAtFirstBoardIndex_RendersPositionZero** ( :x: )
...
- **TC53: refreshViews_WhenPlayerAtLastBoardIndex_RendersPositionThirtyOne** ( :x: )
...
- **TC54: refreshViews_WhenNoCardIsActive_ClearsCardView** ( :x: )
...
- **TC55: refreshViews_WhenCardIsActive_DisplaysCurrentCard** ( :x: )
...
- **TC56: refreshViews_AfterBankruptcy_RemovesPlayerFromVisibleTurnOrder** ( :x: )
