...
- **TC21: handleRollDice_WhenMinimumRollWrapsToGo_MovesToZero** ( :x: )
...
- **TC22: handleRollDice_WhenMaximumRollWrapsAroundBoard_MovesToExpectedIndex** ( :x: )
...
- **TC23: handleRollDice_WhenCurrentPlayerIsBankrupt_DoesNotMovePlayer** ( :x: )
...
- **TC24: handleRollDice_WhenTileEffectCausesBankruptcy_HandlesBankruptcy** ( :x: )
...
- **TC25: handleTileAction_WithNullAction_ThrowsException** ( :x: )
  - **State of the system**: game is in progress, `action = null`
  - **Expected output**: throws `NullPointerException`; no game state changes

- **TC26: handleTileAction_WithValidNoOpAction_RefreshesViewsOnly** ( :x: )
...
- **TC27: handleTileAction_WithPurchaseAtExactBalance_AllowsPurchase** ( :x: )
...
- **TC28: handleTileAction_WithOptionalPurchaseAboveBalance_DoesNotPurchase** ( :x: )
...
- **TC29: handleTileAction_WithMandatoryPaymentAtExactBalance_PaysSuccessfully** ( :x: )
...
- **TC30: handleTileAction_WithMandatoryPaymentAboveBalance_TriggersBankruptcy** ( :x: )
...
- **TC31: handleTileAction_WithActionForWrongTile_RejectsAction** ( :x: )
...
- **TC32: handleEndTurn_WithTwoPlayers_AdvancesToSecondPlayer** ( :x: )
...
- **TC33: handleEndTurn_WithMaximumPlayersMiddleTurn_AdvancesToNextPlayer** ( :x: )
...
- **TC34: handleEndTurn_WithMaximumPlayersAtLastTurn_WrapsToFirstPlayer** ( :x: )
...
- **TC35: handleEndTurn_WithOneActivePlayer_EndsGame** ( :x: )
...
- **TC36: handleEndTurn_WhenNextPlayerIsBankrupt_SkipsRemovedPlayer** ( :x: )
...
- **TC37: handleBankruptcy_WithNullPlayer_ThrowsException** ( :x: )
...
- **TC38: handleBankruptcy_WithPlayerNotInGame_DoesNotChangeGame** ( :x: )
...
- **TC39: handleBankruptcy_WithThreePlayers_RemovesPlayerAndContinuesGame** ( :x: )
...
- **TC40: handleBankruptcy_WithTwoPlayers_RemovesPlayerAndEndsGame** ( :x: )
...
- **TC41: handleBankruptcy_WhenCurrentPlayerIsRemoved_AdvancesToNextActivePlayer** ( :x: )
...
- **TC42: handleBankruptcy_WhenLastPlayerInTurnOrderIsRemoved_WrapsCurrentPlayer** ( :x: )
...
- **TC44: refreshViews_WithNullBoardView_ThrowsExceptionBeforePartialUpdate** ( :x: )
...
- **TC45: refreshViews_WhenPlayerAtFirstBoardIndex_RendersPositionZero** ( :x: )
...
- **TC46: refreshViews_WhenPlayerAtLastBoardIndex_RendersPositionThirtyOne** ( :x: )
...
- **TC47: refreshViews_WhenNoCardIsActive_ClearsCardView** ( :x: )
...
- **TC48: refreshViews_WhenCardIsActive_DisplaysCurrentCard** ( :x: )
...
- **TC49: refreshViews_AfterBankruptcy_RemovesPlayerFromVisibleTurnOrder** ( :x: )
